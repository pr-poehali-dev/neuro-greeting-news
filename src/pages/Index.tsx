...
const STARS: { name: string; category: string; emoji: string; tag: string; videoUrl?: string; img?: string }[] = [
  ...
  { name: "Анна Асти", category: "Певица", emoji: "💫", tag: "NEW", videoUrl: "https://vkvideo.ru/video_ext.php?oid=-238057825&id=456239037&hd=2&autoplay=0&js_api=1&no_allow_player_extensions=1", img: "https://cdn.poehali.dev/projects/90f85c73-4e8a-422c-8e61-c47e03f2914a/bucket/70fdc3ca-f206-4016-8b7e-680e799648e3.jpg" },
];
